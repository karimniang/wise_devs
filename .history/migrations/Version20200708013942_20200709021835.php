...
final class Version20200708013942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant ADD loger_id INT DEFAULT NULL, ADD libelle VARCHAR(255) DEFAULT NULL, ADD montant INT DEFAULT NULL, ADD is_housed TINYINT(1) DEFAULT NULL, ADD adresse VARCHAR(255) DEFAULT NULL, DROP boursier_id, DROP non_boursier_id');
